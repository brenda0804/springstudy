...
<form name="listF" action="board-find.do#bbs">
...
<table class="table table-striped table-condensed table-hover">
	...
	<tr>
		<td colspan="3" align="center">
			<ul class="pagination">
				<li><a href="board-find.do?cpage=${cpage-1}#bbs">Prev</a></li>
				...
				<li><a href="board-find.do?cpage=${cpage+1}#bbs">Next</a></li>
			</ul>
		</td>
...
<br>
<!-- [12.05]검색 form시작------------------------------- -->
<form name="bf" action="board-find.do#bbs"><!-- pageCount 관련 수정(name,action) -->
	<input type="hidden" name="cpage" value="${cpage}">
